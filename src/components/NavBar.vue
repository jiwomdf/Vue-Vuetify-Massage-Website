  ...
  <nav>
    ...
    <div flat app>
      <v-app-bar color="blue lighten-5" flat>
        ...
        <v-toolbar-title>Pijat Kediri</v-toolbar-title>

        <v-spacer></v-spacer>

        <a href="tel:+6281384176860" style="text-decoration:none">
          <v-btn icon>
            <v-icon>mdi-phone</v-icon>
          </v-btn>
        </a>

        <a href="tel:+62895330124172" style="text-decoration:none">
          <v-btn icon>
            <v-img src="../assets/logo/walogo.png" width="30px" height="30px"></v-img>
          </v-btn>
        </a>
